...
namespace DemoPushXamarinForms.Droid
{
    ...
    public class PushHandlerService  : GcmServiceBase
    {
        ...
        protected override void OnMessage(Context context, Intent intent)
        {
            ...
            {
                foreach (var key in intent.Extras.KeySet()) msg.AppendLine(key + "=" + intent.Extras.Get(key).ToString());
            }
        ...
        {
            Log.Verbose(MyBroadcastReceiver.TAG, "GCM Registered: " + registrationId); RegistrationID = registrationId;
